...
// require_once the "HtmlTable.Class.php" file first 
require_once("HtmlTable.Class.php") ;

echo "<h3>First example</h3>" ; 

/*
This array contains all require_onced parameters . 
...
$columnNames = array( "cust_id" , "cust_lg" , "cust_pw" , "cust_fn", "cust_ln", "cust_email", "temp_pass") ; 
  try {
...
/*
An example of all require_onced and optional parameters  .
*/
$config2 = array(
				"db_Host" => "localhost",
				"db_User" => "root" ,
